'''
Author:     Vikas Malik
LinkedIn:   https://www.linkedin.com/in/vikas-malik-3a854310/

Copyright (C) 2024 Vikas Malik
...
# Your legal name
first_name = "Vikas"                 # Your first name in quotes Eg: "First", "Vikas"
middle_name = ""            # Your name in quotes Eg: "Middle", "", ""
last_name = "Malik"                # Your last name in quotes Eg: "Last", "Mallik"

# Phone number (required), make sure it's valid.
phone_number = "6168280615"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Strongsville, Cleaveland"                  # Los Angeles, San Francisco, etc.
'''
